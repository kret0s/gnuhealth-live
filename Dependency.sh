...
sudo pip install hl7apy --upgrade &&
...
sudo pip install relatorio --upgrade &&
...
sudo pip install python-ldap --upgrade &&

sudo pip install vobject --upgrade &&

sudo pip install PyWebDAV --upgrade &&

sudo pip install qrcode --upgrade &&

sudo pip install six --upgrade &&

sudo pip install caldav --upgrade &&

sudo pip install polib --upgrade &&

sudo pip install python-sql --upgrade &&
